                                    ...
                                    <div className="row">
                                        <div className="col-sm-12">
                                            ...
                                            <div style={{ clear: 'both', height: '4rem' }}>
                                                <p className="d-block customdescription">{truncateText(item.Overview, 220)}</p>
                                            </div>
                                            <a onClick={() => gotoNewsDetails(item)} style={{ textDecoration: 'none' }}>
                                        ...
                                        <div className="row align-items-start">
                                            ...
                                            <div className="col-sm-9">
                                                ...
                                                <a > <div className="w-100">
                                                    ...
                                                    <p className="readmore" onClick={() => gotoNewsDetails(item)} style={{ cursor: 'pointer' }}>Read more..</p>
                                                </div>
                                                </a>
                                            </div>
