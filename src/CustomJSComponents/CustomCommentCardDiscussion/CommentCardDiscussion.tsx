...
export const CommentCard: React.FC<{
  ...
  onLike: () => void;
}> = ({ commentId, username, Commenttext, Comments, Created, likes, replies, userHasLiked, CurrentUserProfile,loadingLike, Action, userProfile,onAddReply, onLike ,loadingReply}) => {
