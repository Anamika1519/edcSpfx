                                    ...
                                    <div className="row">
                                        <div className="col-sm-12">
                                            ...
                                            <div style={{ clear: 'both', height: '5rem' }}>
                                                <p style={{lineHeight:'20px'}} className="d-block font-16 text-dark customdescription">{truncateText(item.Overview, 250)}</p>
                                            </div>
                                ...
                                <div className="col-sm-9">
                                    ...
                                    <a onClick={() => gotoAnnouncementDetails(item)}>
                                        <div className="w-100">
                                            ...
                                            <p style={{ color: '#6b6b6b', fontSize: '16px', height: '4rem' }} className="mb-2 font-16 ng-binding">{truncateText(item.Overview, 350)}</p>
