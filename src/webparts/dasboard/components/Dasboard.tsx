                          ...
                          <div key={index} className="border-bottom mt-2">
                            ...
                            <div className="mt-1 mb-0">
                              ...
                              >
                                ...
                                <span className="font-12 floatl">{announcement.LikeCount} Likes</span>
                              </a>
                              <a
                    ...
                    <div className="card" style={{ borderRadius: "1rem" }}>
                      <div className="card-body pb-0 gheight">
                        <h4 className="header-title font-16 text-dark fw-bold mb-0">
                          ...
                          <a
                            style={{ float: "right" }}
                            className="font-11 view-all fw-normal btn btn-primary rounded-pill waves-effect waves-light"
                  ...
                  <div className="col-xl-12 col-lg-12">
                    ...
                    >
                      <div className="card-body pb-2">
                        ...
                        <div className="tab-content pt-1" style={{marginTop:'0.4rem'}}>
                      ...
                      {dataofnews.map((news, index) => {
                        ...
                        /> */}
                            ...
                            <p
                              ...
                              className="mb-2 twolinewrap font-14"
                            >
                              {news.Overview}
                            </p>
