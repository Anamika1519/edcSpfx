...
export default class BusinessAppsWebPart extends BaseClientSideWebPart<IBusinessAppsWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IBusinessAppsProps> = React.createElement(
      BusinessApps,
      {
