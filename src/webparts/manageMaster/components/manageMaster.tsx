...
import { getSettingAPImanagemaster } from "../../../APISearvice/settingsService";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faPaperclip } from '@fortawesome/free-solid-svg-icons';
import HorizontalNavbar from '../../horizontalNavBar/components/HorizontalNavBar';
import styles from "../components/Mastersettings.module.scss"
import { IManageMasterProps } from './IManageMasterProps';
//import { IManagemasterProps } from './IManageMasterProps';
...
const Managemaster : React.FC<IManageMasterProps> = (props) => {
  return (
    <Provider>
