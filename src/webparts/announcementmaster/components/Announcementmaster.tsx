                          ...
                          <tbody>
                            {currentData.length === 0 ?
                              ...
                              (
                                ...
                                <tr key={index}>
                                  <td style={{ minWidth: '50px', maxWidth: '50px' }}>{startIndex + index + 1}</td>
                                  <td>{item.Title}</td>
                                  {/* <td>{item.Overview}</td> */}
                                  ...
                                  <td style={{ minWidth: '50px', maxWidth: '50px' }} className="ng-binding">
                                    <div className="d-flex  pb-2" style={{ justifyContent: 'space-around' }}>
                                      <span > <a className="action-icon text-primary" onClick={() => EditAnnouncement(item.ID)}>
                        ...
                        <table className="mtable mt-0 table-centered table-nowrap table-borderless mb-0" style={{ position: 'relative' }}>
                          ...
                          <tbody>
                            {newsCurrentData.length === 0 ?
                              ...
                              newsCurrentData.map((item: any, index: number) => (
                                <tr key={index}>
                                  <td style={{ minWidth: '50px', maxWidth: '50px' }}>{startIndex + index + 1}</td>
                                  <td>{item.Title}</td>
                                  {/* <td>{item.Overview}</td> */}
