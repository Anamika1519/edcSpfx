...
export default class ChangeDocumentRequestWebPart extends BaseClientSideWebPart<IChangeDocumentRequestWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IChangeDocumentRequestProps> = React.createElement(
