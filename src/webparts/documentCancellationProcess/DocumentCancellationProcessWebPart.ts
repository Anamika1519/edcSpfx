...
export default class DocumentCancellationProcessWebPart extends BaseClientSideWebPart<IDocumentCancellationProcessWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IDocumentCancellationProcessProps> = React.createElement(
      DocumentCancellationProcess,
      {
